    ...
    <div className="min-h-screen bg-bg-canvas text-text-primary flex items-center justify-center p-4 selection:bg-primary selection:text-white">
      <div className="w-full max-w-md bg-bg-surface border border-border rounded-[var(--radius-2xl)] p-8 shadow-[var(--shadow-xl)] space-y-6 cfx-scale-in">
        ...
        <div className="text-center space-y-2">
          ...
          <h1 className="text-[var(--font-size-h3)] font-extrabold text-text-primary tracking-tight">Welcome Back to Conflux</h1>
          <p className="text-[var(--font-size-caption)] text-text-muted">Sign in to access your multi-cloud workspace.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-1">
            <div className="flex justify-between items-center">
              ...
              <Link to="/forgot-password" className="text-[var(--font-size-label)] font-semibold text-primary hover:underline">
                Forgot password?
              </Link>
            </div>
            <div className="relative">
